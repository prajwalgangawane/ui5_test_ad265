		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsapprajwalgangawanetest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapprajwalgangawanetest-display": {
								"semanticObject": "comsapprajwalgangawanetest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.prajwalgangawane.test",
									"url": sap.ui.require.toUrl("com/sap/prajwalgangawane/test")
								}
							}
						}
					}
